...
class IamActionRegistryTest {
    ...
    void s3AccelerateYieldsToSubresourcesDispatchedFirst() {
        ...
        // accelerate mapping must not claim it; the sub-resource dispatched first wins.
        // These two previously asserted s3:CreateBucket and s3:ListBucket, the rule-table
        // fallback, which is the very mismapping this class of bug is about.
